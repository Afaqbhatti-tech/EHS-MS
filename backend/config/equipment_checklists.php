 ...
 * Each key corresponds to a checklist_categories.key value.
 * Each item has: id, section, item (description), type (pass_fail or pass_fail_na).
 */

return [

    // ── FULL BODY HARNESS — Weekly Inspection ────────────────
    // Based on: EN 361 / ANSI Z359.11 / AS/NZS 1891
    ...
    // Based on: BS 5306-3 / NFPA 10 / AS 1851
    ...
    // Based on: EN 131 / OSHA 1926.1053 / AS/NZS 1892
    ...
    // Based on: OSHA 29 CFR 1926.303 / AS/NZS 4600
    ...
    // Based on: ASME B30.10 / BS EN 1677 / AS 3776
    ...
    // Based on: IPAF / OSHA 1926.1431 / AS 1418.10
